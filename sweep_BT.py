...
'Value', and a function get_temperature(Device).
Assumes the time for temperature to stabilise is 't_temp'.
'''
...
lockin_ref_V = ... # ! what determines this? (could be heat)
lockin_ref_phi = 0
...
for T in temps: 
    ...
    for B in Bs:
        ...
        magnet.field(B) # set field to desired point 
